...
export default function Lodyons3({route,navigation}) {
    ...
    const handlePress = async () => {
        try {
            ...
            fetch('https://taxcalculator.ml/lodyons3.php', {
        method: 'POST',
        headers: {
...
/>
          ...
          <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>มูลค่าไม่เกิน 3,000,000 บาท</Text>
                </View>
            ...
            <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>ตามจำนวนที่จ่ายจริง แต่ไม่เกิน 100,000 บาท</Text>
                </View>
                <View style={{width:'35%',paddingHorizontal:15}}>
                    <View style={{borderWidth:1,borderRadius: 10}}>
                    <TextInput
            ...
            <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>ตามจำนวนที่จ่ายจริง แต่ไม่เกิน 10,000 บาท</Text>
                </View>
                <View style={{width:'35%',paddingHorizontal:15}}>
                    <View style={{borderWidth:1,borderRadius: 10}}>
                    <TextInput
