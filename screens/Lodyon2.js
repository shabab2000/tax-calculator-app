...
export default function Lodyon2({route,navigation}) {
    ...
    const handlePress = async () => {
        try {
            ...
            fetch('https://taxcalculator.ml/lodyon2.php', {
        method: 'POST',
        headers: {
...
/>
          ...
          <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>คุ้มครอง/ฝาก ตั้งแต่ 5 ปีเป็นต้นไป ตามจำนวนจริง</Text>
                </View>
            ...
            <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>ตามจำนวนที่จ่ายจริง แต่ไม่เกิน 12,500 บาท </Text>
                </View>
                <View style={{width:'35%',paddingHorizontal:15}}>
                    <View style={{borderWidth:1,borderRadius: 10}}>
                    <TextInput
            ...
            <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>ไม่เกินร้อยละ 7.5 ของเงินได้ และไม่เกิน 100,000 บาท</Text>
                </View>
                <View style={{width:'35%',paddingHorizontal:15}}>
                    <View style={{borderWidth:1,borderRadius: 10}}>
                    <TextInput
            ...
            <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>ไม่เกินร้อยละ 7.5 ของเงินได้ และไม่เกิน 250,000 บาท</Text>
                </View>
                <View style={{width:'35%',paddingHorizontal:15}}>
                    <View style={{borderWidth:1,borderRadius: 10}}>
                    <TextInput
            ...
            <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>ตามจำนวนที่จ่ายจริง แต่ไม่เกิน 6,600 บาท </Text>
                </View>
                <View style={{width:'35%',paddingHorizontal:15}}>
                    <View style={{borderWidth:1,borderRadius: 10}}>
                    <TextInput
            ...
            <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>ไม่เกินร้อยละ 15 ของเงินได้ และไม่เกิน 250,000 บาท</Text>
                </View>
                <View style={{width:'35%',paddingHorizontal:15}}>
                    <View style={{borderWidth:1,borderRadius: 10}}>
                    <TextInput
            ...
            <View style={{display: 'flex',flexDirection: 'row',}}>
                <View style={{paddingHorizontal:20,width:'65%'}}>
                    ...
                    <Text style={{fontSize:10}}>ไม่เกินร้อยละ 15 ของเงินได้ และไม่เกิน 100,000 บาท</Text>
                </View>
                <View style={{width:'35%',paddingHorizontal:15}}>
                    <View style={{borderWidth:1,borderRadius: 10}}>
                    <TextInput
