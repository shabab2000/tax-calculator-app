...
export default function Lodyon({route,navigation}) {
    ...
    return (
        <View style={styles.container}>
          ...
          <ListItem  bottomDivider topDivider onPress={() => navigation.replace('Lodyon1')}>
        <ListItem.Content>
      ...
      <ListItem  bottomDivider topDivider onPress={() => navigation.replace('Lodyon2')}>
        <ListItem.Content>
      ...
      <ListItem  bottomDivider topDivider onPress={() => navigation.replace('Lodyon3')}>
        <ListItem.Content>
      ...
      <ListItem  bottomDivider topDivider onPress={() => navigation.replace('Lodyon4')}>
        <ListItem.Content>
